...
java -jar ../mkgmap-r3701/mkgmap.jar --family-id=%family_id% ../conf/typfile.txt
...
java -Xmx1024m -jar ../mkgmap-r3701/mkgmap.jar -c next.args -c template.args %family_id%*.osm.pbf typfile.typ
